...
GEOFABRIK_URLS = {
    ...
    'PF' : 'https://download.geofabrik.de/australia-oceania/polynesie-francaise-latest.osm.pbf',
    'YT' : 'https://download.geofabrik.de/europe/france/mayotte-latest.osm.pbf',
    'PR' : 'https://download.geofabrik.de/north-america/us/puerto-rico-latest.osm.pbf',
    'RE' : 'https://download.geofabrik.de/europe/france/reunion-latest.osm.pbf',
    'VC' : 'https://geo2day.com/central_america/saint_vincent_and_the_grenadines.pbf',
    'TT' : 'https://geo2day.com/central_america/trinidad_and_tobago.pbf',
    'TC' : 'https://geo2day.com/central_america/turks_and_caicos_islands.pbf',
    'VI' : 'https://download.geofabrik.de/north-america/us/us-virgin-islands-latest.osm.pbf',
    'EH' : 'https://geo2day.com/africa/western_sahara.pbf',
    'VG' : 'https://geo2day.com/central_america/british_virgin_islands.pbf'
}
